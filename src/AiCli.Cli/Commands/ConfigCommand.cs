...
public class ConfigCommand : CommandBase
{
    ...
    {
        _console.MarkupLine("[bold]Usage:[/] aicli config [options]");
        _console.WriteLine();
        ...
        _console.MarkupLine("  [green]aicli config --api-key sk-...[/]");
        _console.MarkupLine("  [green]aicli config --model gemini-pro[/]");
        _console.MarkupLine("  [green]aicli config --base-url http://localhost:11434[/]");
        _console.MarkupLine("  [green]aicli config --show[/]");
    }
}
