...
namespace GeminiCli.Core.Logging;
...
public static class LoggerHelper
{
    ...
    public static ILogger CreateLogger(LoggerConfig config)
    {
        var loggerConfiguration = new LoggerConfiguration()
            ...
            .Enrich.WithProperty("Application", "GeminiCli")
            ;
    ...
    private static string GetLogFilePath(string? customPath)
    {
        ...
        return Path.Combine(logDir, "gemini-cli-.log");
    }
    ...
    {
        Log.Logger = logger;
        Log.Information("Gemini CLI logger initialized");
    }
